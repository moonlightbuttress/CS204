...
public class YourAspect {
    ...
    * The pointcut will look for the @test.YourAnnotation
    */
    @Pointcut("@annotation(test.YourAnnotation)")
    ...
    */
    ...
    /**
    * Defines a pointcut where the @test.YourAnnotation exists
    * and combines that with a catch-all pointcut with the scope of execution
    */
    @Around("@annotation(test.YourAnnotation) && execution(* *(..))")
    /**
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            System.out.println("test.YourAspect's aroundAdvice's body is now executed Before yourMethodAround is called.");
            ...
            System.out.println("test.YourAspect's aroundAdvice's body is now executed After yourMethodAround is called.");
        }
        return returnObject;
    }
